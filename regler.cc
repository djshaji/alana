...
static gboolean Regler_signal_value_entry_callback(GxRegler* self, GdkRectangle* p0,void* p1,void* data)
{
  using namespace Gxw;
  using SlotType = sigc::slot< bool,const Gdk::Rectangle&,void* >;
...
static gboolean Regler_signal_value_entry_notify_callback(GxRegler* self, GdkRectangle* p0,void* p1, void* data)
{
  using namespace Gxw;
  using SlotType = sigc::slot< void,const Gdk::Rectangle&,void* >;
...
gboolean Regler_Class::value_entry_callback(GxRegler* self, GdkRectangle* p0, void* p1)
{
...
Glib::SignalProxy< bool,const Gdk::Rectangle&,void* > Regler::signal_value_entry()
{
  return Glib::SignalProxy< bool,const Gdk::Rectangle&,void* >(this, &Regler_signal_value_entry_info);
}
...
bool Gxw::Regler::on_value_entry(const Gdk::Rectangle& p1, void* p2)
{
  const auto base = static_cast<BaseClassType*>(
